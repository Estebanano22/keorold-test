...
exports.validarRegistro = async (req, res, next) => {
  ...
  const rules = [
    ...
    body("enlacePatrocinador")
      .not()
      .isEmpty()
      .withMessage("El código de afiliación no puede ser vacio")
      .escape(),
    body("email")
      .isEmail()
    ...
    body("password")
      ...
      .isEmpty()
      .isLength({ min: 10 })
      .withMessage("El password debe ser mayor a 10 caracteres")
      .escape(),
    body("enlacePatrocinador")
      .equals(validacionDist + "-" + perfilEnlace)
      .withMessage("El código de afiliación no es valido"),
  ];
...
exports.recuperarPasswords = async (req, res) => {
  ...
  res.json({
    titulo: "¡Que bien!",
    resp: "success",
    descripcion: "Te hemos enviado un E-mail para resstablecer tu contraseña.",
  });
  return;
};
